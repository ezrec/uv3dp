...
func TestEmptyToRaw(t *testing.T) {
	...
	for _, item := range table {
		...
		if !bytes.Equal(encoded_buff, emptyRaw) {
			t.Errorf("expected [%d byte encoding], got [%d byte encoding]", len(emptyRaw), len(encoded_buff))
